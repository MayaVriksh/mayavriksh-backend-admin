...
const showWarehouseEmployeeProfile = async userId => {
    ...
    // console.log("Wareehouse Employee Profile: ", profile);
    ...
    if (!profile.user?.isActive || profile.user?.deletedAt !== null) {
        throw {
            success: RESPONSE_FLAGS.FAILURE,
            code: RESPONSE_CODES.BAD_REQUEST,
